...
การวิเคราะห์แบ่งออกเป็น 2 ส่วนหลัก ได้แก่ Cluster Analysis และ Discriminant Analysis โดยในส่วนของ Cluster Analysis มีการเปรียบเทียบผลจาก Hierarchical Clustering และ K-Means Clustering ก่อนนำผลการแบ่งกลุ่มไปศึกษาต่อด้วย Discriminant Analysis
...
นอกจากนี้ การวิเคราะห์ใช้ตัวแปรเพียง 4 ตัว จึงยังไม่ครอบคลุมปัจจัยด้านเศรษฐกิจและสังคมอื่นที่อาจช่วยอธิบายความแตกต่างระหว่างประเทศได้

แนวทางสำหรับการวิเคราะห์เพิ่มเติมสามารถพิจารณาการ Transform ตัวแปรที่มีการกระจายเบ้ เพิ่มตัวแปร เช่น GDP per capita หรือ HDI และทดลองใช้ PCA เพื่อลดมิติก่อนทำ Cluster Analysis
